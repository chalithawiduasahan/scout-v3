...
function ScaleSelect({
  ...
  const selected = SCALE_OPTIONS.find(
    (o) => o.value === value
  );
...
export default function Dashboard() {
  ...
  const [gmailAppPassword, setGmailAppPassword] =
    useState(
      () =>
        localStorage.getItem(
  ...
  const [mailboxConnected, setMailboxConnected] =
    useState(false);

  const [mailboxNote, setMailboxNote] =
    useState<{
      msg: string;
      type: 'success' | 'error';
    } | null>(null);
  ...
  // Batch Queue State
  const [resultsQueue, setResultsQueue] =
    useState<any[]>([]);
  ...
  // Kept only as a backward-compatibility fallback for older queue payloads.
  // New payloads now contain an explicit recipient_email field.
  const extractEmail = (
    text: string
  ) => {
    const match =
  ...
  const runScout =
    async () => {
      if (
        ...
        setError(
          'Enter both a niche and a location to run the scout.'
        );
      ...
      setStatus(
        'Discovering & generating multi-channel demos...'
      );
      ...
      try {
        ...
        if (!res.ok) {
          throw new Error(
            data.detail ||
            'Something went wrong running the scout.'
          );
        }
    ...
    async () => {
      ...
      try {
        const payload = {
          ...
          form_screenshot:
            currentItem.demo_result.form_screenshot,

          airtable_screenshot:
            currentItem.demo_result.airtable_screenshot,

          email_screenshot:
            currentItem.demo_result.email_screenshot,

          slack_screenshot:
            currentItem.demo_result.slack_screenshot,
        };
        ...
        if (res.ok) {
          setSendNote({
            msg:
              `Email sent via SMTP (${gmailAddress})! Logged to History.`,
            type: 'success'
          });
      ...
      {lightbox && (
        <div className="fixed inset-0 z-50 flex flex-col items-center justify-center bg-ink-950/90 backdrop-blur-sm p-4">
          ...
          <img
            src={lightbox.url}
            alt="Screenshot"
            className="max-h-[80vh] max-w-[95vw] rounded-xl border border-white/10 shadow-2xl object-contain"
          />

          <p className="mt-4 font-medium text-ink-300 text-center">
            {lightbox.cap}
          </p>
        </div>
      )}
      ...
      <aside
        className={`${
          sidebarOpen
            ? 'w-64'
            : 'w-20'
        } flex flex-col border-r border-white/5 bg-ink-900/40 transition-all duration-300 shrink-0`}
      >
          ...
          {activeTab === 'home' ? (
            ...
            <div className="animate-fade-up">
              ...
              <p className="mt-2 text-ink-300">
                Point it at a niche, location,
                and run count — it'll take it
                from there.
              </p>
              ...
              <div className="glass-strong mt-8 grid gap-4 rounded-2xl p-6 sm:grid-cols-5 sm:items-end">
                ...
                <div className="flex flex-col gap-2 sm:col-span-1">
                  ...
                  <input
                    ...
                    className="rounded-xl border border-white/10 bg-white/5 px-4 py-2.5 text-sm focus:border-scout-400 focus:outline-none"
                  />
                </div>
                ...
                <button
                  onClick={runScout}
                  disabled={loading}
                  className="flex h-[42px] items-center justify-center rounded-xl bg-gradient-to-r from-scout-400 to-aqua-500 font-semibold text-ink-950 transition-transform hover:scale-[1.02] active:scale-95 disabled:opacity-50 sm:col-span-1"
                >
                  Run scout
                </button>
                ...
                currentItem && (
                  <div className="mt-10 space-y-6 animate-fade-up">
                    ...
                    <div className="glass rounded-2xl p-6">
                      ...
                      {/* Public business data discovered by Linkup */}
                      <div className="mt-5 grid gap-3 sm:grid-cols-2">
                        ...
                        <div className="rounded-xl border border-white/5 bg-white/5 p-4">
                          ...
                          <div className="mt-1 flex items-center gap-2 text-sm text-ink-200 break-all">
                      ...
                      {/* Existing detailed research view */}
                      <div className="mt-5 max-h-60 overflow-y-auto whitespace-pre-wrap border-t border-white/5 pt-4 text-sm leading-relaxed text-ink-300">
                        {currentItem.research_profile}
                      </div>
                    ...
                    <div className="glass rounded-2xl p-6">
                      ...
                      <h2 className="mb-4 text-xs font-semibold uppercase tracking-wider text-ink-400">
                        Proof of the demo (4-Step Workflow)
                      </h2>
                            ...
                            {recipientEmail ? (
                              currentItem.contact_email ? (
                                <>
                                  ...
                                  by Hunter. The Linkup
                                  website email remains the
                                  fallback.
                                </>
                              ) : currentItem.website_email ? (
                                <>
                                  No suitable personal
                                  contact was found by
                                  Hunter, so Scout is using
                                  the exact website email
                                  found by Linkup.
                                </>
                              ) : (
                                <>
                                  Auto-filled from Scout's
                                  available research.
                                </>
                              )
                            ) : (
                              <>
                                Scout could not find a
                                recipient automatically.
                                Enter one manually before
                                sending.
                              </>
                            )}
            ...
            <div className="animate-fade-up">
              ...
              {selectedHistoryItem ? (
                ...
                <div className="space-y-6">
                  ...
                  <div className="glass-strong rounded-2xl p-6 space-y-4">
                    ...
                    <div>
                      ...
                      <div className="mt-1 font-medium text-white text-sm">
                        {
                    ...
                    <div>
                      ...
                      <div className="mt-1 whitespace-pre-wrap text-sm text-ink-300 bg-white/5 p-4 rounded-xl border border-white/5">
                        {
                ...
                <div>
                  ...
                  <p className="mt-2 text-ink-300">
                    Every business you've reached out to will show up here.
                  </p>
                  ...
                  {historyItems.length === 0 ? (
                    ...
                    <div className="mt-8 rounded-2xl border border-dashed border-white/10 p-12 text-center text-sm text-ink-400">
                      No outreach sent yet. Once you approve
                      and send outreach from Home, it'll appear here.
                    </div>
                      ...
                      {historyItems.map(
                        (item) => (
                          ...
                          <div
                            ...
                            className="glass group cursor-pointer flex items-center justify-between rounded-2xl p-5 transition-all hover:border-scout-400"
                          >
            ...
            <div className="animate-fade-up">
              ...
              <p className="mt-2 text-ink-300">
                Real-time performance metrics for your AI outreach engine.
              </p>
              ...
              <div className="mt-8 grid gap-6 sm:grid-cols-3">
                ...
                <div className="glass rounded-2xl p-6">
                  ...
                  <p className="mt-2 text-xs text-ink-400">
                    Businesses successfully researched and emailed
                  </p>
                ...
                <div className="glass rounded-2xl p-6">
                  ...
                  <p className="mt-2 text-xs text-ink-400">
                    Saved on manual lead gen & demo prototyping
                  </p>
                ...
                <div className="glass rounded-2xl p-6">
                  ...
                  <p className="mt-2 text-xs text-ink-400">
                    Live agent success rate across all pipelines
                  </p>
              ...
              <div className="glass-strong mt-8 rounded-2xl p-6">
                ...
                {historyItems.length === 0 ? (
                  ...
                  <p className="text-sm text-ink-400 py-6 text-center">
                    No activity recorded yet. Run your first scout on
                    the Home tab to populate metrics!
                  </p>
